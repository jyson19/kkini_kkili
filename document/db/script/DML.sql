...
INSERT INTO contact VALUES(seq_cid.nextval, 1, 9, TO_CHAR(TO_DATE('20210412120000', 'YYYYMMDDHH24MISS'), 'YYYY-MM-DD HH24:MI:SS'), '삼성공화국 Q&A', '스시쿤 판교', '경기 성남시 분당구 대왕판교로 660 유스페이스몰 1차 지하1층 115호', '2021-04-13 12:30', 8000, 60000, 1);
INSERT INTO contact VALUES(seq_cid.nextval, 2, 9, TO_CHAR(TO_DATE('20210413150000', 'YYYYMMDDHH24MISS'), 'YYYY-MM-DD HH24:MI:SS'), 'KT보다 SK로 가야하는 이유', '봉피양 판교점', '경기 성남시 분당구 판교역로 235 H스퀘어 N동 121,122호', '2021-04-14 12:30', 9000, 70000, 1);
INSERT INTO contact VALUES(seq_cid.nextval, 3, 9, TO_CHAR(TO_DATE('20210414180000', 'YYYYMMDDHH24MISS'), 'YYYY-MM-DD HH24:MI:SS'), '쿠팡은 어떻게 중견기업이 되었나', '황제갈비 판교점', '경기 성남시 분당구 대왕판교로 670 유스페이스2A동 1층 104호', '2021-04-15 12:30', 10000, 80000, 1);

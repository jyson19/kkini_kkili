...
<div class="card">
    ...
    <div class="card-block">
        <form method="post" action="saveProfile.do" name="userinput" id="userinput">
        <h4 class="sub-title">NO.<%=member.getMemberId()%></h4>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">이름</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="<%=member.getName()%>" disabled>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">이메일</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="<%=member.getEmail()%>" disabled>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">연락처</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<%=member.getTel()%>" disabled>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">회사</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="회사명" name='company'>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">학교</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="학교명" name='uni'>
                </div>
            </div>
                                                           <!-- <div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="file" class="form-control" name='host_pic'>
    </div>
</div>
<div class="form-group row">
    <label class="col-sm-2 col-form-label">프로필 자료</label>
    <div class="col-sm-10">
        <div class="form-control-static">얼굴을 되도록 보여주세요 (증명사진 등 사진을 찍어 올려주세요)
        </div>
    </div>
</div>
<div class="form-group row">
    <label class="col-sm-2 col-form-label">증명 파일</label>
    <div class="col-sm-10">
        <input type="file" class="form-control" name='host_pic'>
    </div>
</div>
<div class="form-group row">
    <label class="col-sm-2 col-form-label">증명 자료</label>
    <div class="col-sm-10">
        <div class="form-control-static">신분을 증명해주세요 (명함, 신분증 등 사진을 찍어 올려주세요)
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <textarea rows="5" cols="5" class="form-control" placeholder="경력사항 등 자신을 소개해 주세요 (흥미로운 경험을 들려주세요)"></textarea>
    </div>
</div>

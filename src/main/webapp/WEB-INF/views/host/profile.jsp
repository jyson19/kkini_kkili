        ...
        <div class="row">
          <div class="col-md-12 ftco-animate">
            ...
            <p>안녕하세요. 오늘 날씨가 참 좋습니다. 어떻게 잘 지내고 계신지는 모르겠어요. 요즘 저는 프로젝트하나라 바쁘게 지내는 것 같습니다. 요즘 저는 프로젝트하나라 바쁘게 지내는 것 같습니다. 요즘 저는 프로젝트하나라 바쁘게 지내는 것 같습니다. 토스도 공고 나왔던데 가고 싶어요. 아무튼 프로젝트 잘 해서 포트폴리오 한번 기막히게 구성해 봅시다.</p>
             ...
             -->
            <p>요즘 코로나 때문에 누구 만나지도 못하는데, 이번에 이런 서비스가 생겨서 한번 사용해보고 싶네요. 어쨌든지 간에 재밌게 사용할 수 있을 것 같습니다. 점심한끼 합시다.</p>
            <h2 class="mb-3 mt-5">어떤 업무에 종사하고 계신가요?</h2>
            <p>나는 지금 포트폴리오를 만들기 위해 열심히 프론트단을 고치고 있습니다. 장인정신이 필요한 작업인 거 같아요. 나중에 백엔드에서 DB로 연결해야하고 지금 링크건 것도 전부 다 콘트럴러 쪽으로 변경해야하는데 팀원들이 많이 도와주리라 믿습니다. 감사합니다.</p>
            <!-- <p>
              <img src="images/image_8.jpg" alt="" class="img-fluid">
            </p> -->
            <p>참 사진이 이쁜 거 같아요. 그죠? 빨리 여행이나 가고 싶네요. 근데 돈이 없어서 ㅠㅠ. 일단 취직부터 해야겠습니다. 어떤 말을 써야할지 감이 안잡히는데 일단 구성은 해야 하니까요...</p>
            <p>미국의 하버드, 그리고 엠아이티, 유럽의 저기 어디냐 아.. 기억이 안나는데 취리히 공대 말고 로잔 공대다. 로잔 공대가 멋졌던 것 같습니다. 꼭 한번 공부하러 가보고 싶네요. 자연 환경속에서 공부가 잘되겠죠?</p>
            <p>대충 말해도 뭔가 있어보이는 말이 있을지 모르겠네요. 구성은 알차고 좋아야 하니까 대충 말해도 보이겠죠.</p>
            <p>사진이 이쁜 거 같아요. 그죠? 빨리 여행이나 가고 싶네요. 근데 돈이 없어서 ㅠㅠ. 일단 취직부터 해야겠습니다. 어떤 말을 써야할지 감이 안잡히는데 일단 구성은 해야 하니까요</p>
            ...
            <div class="pt-5 mt-5">
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="#" class="p-5 bg-light">
                  ...
                  <div class="form-group">
                    <input type="submit" value="남기기" class="btn py-3 px-4 btn-primary">
                  </div>

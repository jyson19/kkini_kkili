                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">로그인하기</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="${pageContext.request.contextPath}/main/sign.do"><b>회원가입하기</b></a></p>
                                        </div>
                                        <!-- 로고 위치 -->
                                        <!-- <div class="col-md-2">
